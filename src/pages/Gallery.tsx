    ...
    },
    {
      ...
      images: [
        ...
        },
        {
          ...
          caption:
            'Say goodbye to wrinkles with our expert anti-wrinkle injections, delivering smooth, youthful skin at our Poole salon with over 15 years of aesthetic expertise',
        },
        {
          id: 4,
          type: 'image',
          ...
          alt: 'Facial aesthetics at Glisten Hair & Aesthetics in Poole',
          caption:
            'Enhance your smile with our expertly crafted lip fillers, designed for natural beauty and confidence at our Poole salon.',
        },
        {
          id: 5,
          type: 'image',
          ...
          alt: 'Facial aesthetics at Glisten Hair & Aesthetics in Poole',
          caption:
            'Achieve flawless, glowing skin with our expert dermaplaning treatments at our Poole salon, designed to refresh and rejuvenate.',
        },
      ],
    },
    {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore the gallery at Glisten Hair & Aesthetics in Poole BH15. View hair styling, aesthetics, men’s hair replacement, and Japanese Head Spa transformations. Book now!"
        />
        <meta
          name="keywords"
          content="gallery hairdresser near me, men’s hair replacement near me, hair stylist Poole, aesthetics Poole, hair extensions Poole, Japanese Head Spa Poole, Poole BH15"
        />
        ...
        <div className="container mx-auto px-4 py-8 sm:py-12 lg:py-16">
          ...
          <div className="text-center mt-12">
            ...
            <a href="https://that-time.co.uk/glisten-hair-aesthetics" target="_blank" rel="noopener noreferrer">
              <Button className="bg-glisten-gold hover:bg-glisten-yellow text-glisten-olive font-semibold py-3 px-6">
                Book Online Now
              </Button>
            </a>
          </div>
              ...
              >
                ...
                {filteredImages.find((item) => item.src === selectedImage)?.type === 'video' ? (
                  <video
                    src={selectedImage}
                    aria-label={
                      filteredImages.find((item) => item.src === selectedImage)?.alt || 'Enlarged gallery video'
                    }
                  ...
                  <img
                    src={selectedImage}
                    alt={
                      filteredImages.find((item) => item.src === selectedImage)?.alt || 'Enlarged gallery image'
                    }
