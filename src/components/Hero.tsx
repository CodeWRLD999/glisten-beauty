...
const Hero = () => {
  return (
    <>
      <Head>
        <title>Glisten Hair & Aesthetics - Expert Hair Stylist in Poole BH15</title>
        <meta name="description" content="Discover Glisten Hair & Aesthetics, your top hair stylist in Poole BH15. Enjoy expert hairdressing, aesthetics, hair extensions, and Japanese Head Spa in our purpose-built salon. Book now!" />
        <meta name="keywords" content="hair stylist Poole, beauty salon Poole, aesthetics Poole, hair extensions Poole, Japanese Head Spa Poole, Poole BH15" />
        <meta name="robots" content="index, follow" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="canonical" href="https://your-domain.vercel.app" /> {/* Replace with your live URL */}
      </Head>
